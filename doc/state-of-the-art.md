...
- OCA MakeForm - модуль введення даних в комп'ютер. (Детальніше)
- OCA CATI - набір програм дозволяють проводити телефонні опитування за допомогою комп'ютера.
- OCA CAPI Android - набір програм дозволяють проводити інтерв'ювання за допомогою планшетів або смартфонів під управлінням Android. 
